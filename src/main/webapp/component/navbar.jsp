...
<!-- <nav class="navbar navbar-expand-lg navbar-dark bg-success">-->
 <nav class="navbar navbar-expand-lg navbar navbar-dark bg-dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="index.jsp">GOCHEETA</a>
      ...
      <c:if test="${empty userObj }">
       ...
       <li class="nav-item">
        ...
        <c:if test="${not empty userObj }">
           ...
           <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="user_booking.jsp">Vehicle Bookings</a>
        </li>
        
           <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="view.booking.jsp">View Bookings</a>
          
        </li>
        
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="calculation.jsp">Payments</a>
